...
database_name = case Padrino.env
  when :development then 'aquiub_development'
  when :production  then 'aquiub_production'
  when :test        then 'aquiub_test'
end
